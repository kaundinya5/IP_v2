(function umd(require) {
    ...
    69: [function(require, module, exports) {
        ...
        function isLocalStorageNameSupported() {
            try {
                return (localStorageName in win && win[localStorageName]) } catch (err) {
                return false }
        }
    ...
    70: [function(require, module, exports) {
        ...
        var each;
        try { each = require('@ndhoule/each'); } catch (e) { each = require('each'); }
    ...
    72: [function(require, module, exports) {
        ...
        var keys;
        try { keys = require('@ndhoule/keys'); } catch (e) { keys = require('keys'); }
    ...
    173: [function(require, module, exports) {
        ...
        exports.load = function(name, locals, callback) {
            ...
            if (typeof name === 'function') { callback = name;
                locals = null;
                name = null; }
            if (name && typeof name === 'object') { callback = locals;
                locals = name;
                name = null; }
            if (typeof locals === 'function') { callback = locals;
                locals = null; }
    ...
    85: [function(require, module, exports) {
        ...
        Autosend.prototype.initialize = function() {
            ...
            (function() {
                var a, b, c;
                a = function(f) {
                    return function() { window._autosend.push([f].concat(Array.prototype.slice.call(arguments, 0))); }; };
                b = ["identify", "track", "cb"];
                for (c = 0; c < b.length; c++) { window._autosend[b[c]] = a(b[c]); } })();
            /* eslint-enable */
            this.load(this.ready);
        };
    ...
    88: [function(require, module, exports) {
        ...
        Blueshift.prototype.initialize = function() {
            ...
            /* eslint-disable */
            window.blueshift.load = function(a) { window._blueshiftid = a;
                var d = function(a) {
    ...
    92: [function(require, module, exports) {
        ...
        Chameleon.prototype.initialize = function() {
            /* eslint-disable */
            (window.chmln = {}), names = 'setup alias track set'.split(' ');
            for (var i = 0; i < names.length; i++) {
                (function() {
                    var t = chmln[names[i] + '_a'] = [];
                    chmln[names[i]] = function() { t.push(arguments); }; })() };
            /* eslint-enable */
    ...
    99: [function(require, module, exports) {
        ...
        Customerio.prototype.initialize = function() {
            ...
            (function() {
                var a, b, c;
                a = function(f) {
                    return function() { window._cio.push([f].concat(Array.prototype.slice.call(arguments, 0))); }; };
                b = ['identify', 'track'];
    ...
    109: [function(require, module, exports) {
        ...
        FullStory.prototype.initialize = function() {
            ...
            (function(m, n, e, t, l, o, g, y) {
                ...
                g.q = [];
                g.identify = function(i, v) { g(l, { uid: i });
                    if (v) g(l, v) };
                g.setUserVars = function(v) { FS(l, v) };
                g.setSessionVars = function(v) { FS('session', v) };
                g.setPageVars = function(v) { FS('page', v) };
                self.ready();
                self.load();
    ...
    123: [function(require, module, exports) {
        ...
        Keen.prototype.initialize = function() {
            ...
            /* eslint-disable */
            !(function(a, b) {
                if (void 0 === b[a]) { b["_" + a] = {}, b[a] = function(c) { b["_" + a].clients = b["_" + a].clients || {}, b["_" + a].clients[c.projectId] = this, this._config = c }, b[a].ready = function(c) { b["_" + a].ready = b["_" + a].ready || [], b["_" + a].ready.push(c) };
                    for (var c = ["addEvent", "setGlobalProperties", "trackExternalLink", "on"], d = 0; d < c.length; d++) {
                        ...
                        b[a].prototype[e] = f(e) } } })("Keen", window);
            /* eslint-enable */
        ...
        LiveChat.prototype.attachListeners = function() {
            ...
            window.LC_API.on_chat_started = function(data) {
                self.analytics.track(
                    'Live Chat Conversation Started', { agentName: data.agent_name }, {
            ...
            window.LC_API.on_message = function(data) {
                if (data.user_type === 'visitor') {
                    ...
                    self.analytics.track(
                        'Live Chat Message Received', { agentName: data.agent_name, agentUsername: data.agent_login }, {
                            context: { integration: integrationContext }
                        });
                }
            };
    ...
    129: [function(require, module, exports) {
        ...
        Lytics.prototype.initialize = function() {
            ...
            window.jstag = (function() {
                var t = { _q: [], _c: options, ts: (new Date()).getTime() };
        ...
        Mixpanel.prototype.initialize = function() {
            ...
            (function(c, a) { window.mixpanel = a;
                ...
                a.init = function(b, c, f) {
                    ...
                    a._i.push([b, c, f]); };
                a.__SV = 1.2; })(document, window.mixpanel || []);
            /* eslint-enable */
        ...
        Nudgespot.prototype.initialize = function() {
            ...
            window.nudgespot.init = function(n, t) {
                function f(n, m) {
                    ...
                    n[m] = function() { n.push([m].concat(Array.prototype.slice.call(arguments, 0))) } }
                n._version = 0.1;
                n._globals = [t];
                n.people = n.people || [];
                n.params = n.params || [];
    ...
    136: [function(require, module, exports) {
        ...
        Olark.prototype.load = function(callback) {
            ...
            window.olark || (function(c) {
                var f = window,
                    ...
                    z = c.name,
                    r = "load";
                var nt = function() { f[z] = function() {
                        (a.s = a.s || []).push(arguments) };
                    var a = f[z]._ = {},
                        q = c.methods.length;
                    while (q--) {
                        (function(n) { f[z][n] = function() { f[z]("call", n, arguments) } })(c.methods[q]) }
                    a.l = c.loader;
                    a.i = nt;
                    a.p = { 0: +new Date() };
                    ...
                    var ld = function() {
                        ...
                        v[j](b);
                        try { b.contentWindow[g].open() } catch (w) { c[e] = d[e];
                            o = "javascript:var d=" + g + ".open();d.domain='" + d.domain + "';";
                            b[k] = o + "void(0);" }
                        try {
                            var t = b.contentWindow[g];
                            t.write(p());
                            t.close() } catch (x) { b[k] = o + 'd.write("' + p().replace(/"/g, String.fromCharCode(92) + '"') + '");d.close();' }
                        a.P(2) };
                    ld() };
                nt() })({ loader: "static.olark.com/jsclient/loader0.js", name: "olark", methods: ["configure", "extend", "declare", "identify"] });
            /* eslint-enable */
        ...
        Olark.prototype.attachListeners = function() {
            ...
            api('chat.onBeginConversation', function() {
                self.analytics.track(
                    'Live Chat Conversation Started', {}, { context: { integration: integrationContext } }
                );
            });
            ...
            api('chat.onMessageToOperator', function() {
                self.analytics.track(
                    'Live Chat Message Sent', {}, { context: { integration: integrationContext } }
                );
            });
            ...
            api('chat.onMessageToVisitor', function() {
                self.analytics.track(
                    'Live Chat Message Received', {}, { context: { integration: integrationContext } }
                );
            });
        };
    ...
    137: [function(require, module, exports) {
        ...
        Optimizely.prototype.roots = function() {
            ...
            each(activeExperiments, function(props) {
                self.analytics.track(
                    'Experiment Viewed',
                    props, { context: { integration: integrationContext } }
                );
            });
        };
            ...
            (function(a, b) {
                ...
                function e(b) {
                    ...
                    return g(function() {
                        ...
                        var f = Array.prototype.slice.call(arguments, 0),
                            g = { shim: c, method: b, args: f, ts: new Date };
                ...
                function g(a, b) {
                    return b = b || this.logger,
                        function() {
                            try {
                                return a.apply(this, arguments) } catch (c) { b("Rollbar internal error:", c) } } }
                var h = 0;
                c.init = function(a, b) {
                    ...
                    return g(function() {
                        ...
                        return a[e] = h, h }, h.logger)() }, c.prototype.loadFull = function(a, b, c, d, e) {
                    var f = g(function() {
                            var a = b.createElement("script"),
                                e = b.getElementsByTagName("script")[0];
                            a.src = d.rollbarJsUrl, a.async = !c, a.onload = h, e.parentNode.insertBefore(a, e) }, this.logger),
                        h = g(function() {
                            var b;
                            if (void 0 === a._rollbarPayloadQueue) {
                                ...
                                for (b = new Error("rollbar.js did not load"); c = a._rollbarShimQueue.shift();)
                                    for (f = c.args, g = 0; g < f.length; ++g)
                                        if (d = f[g], "function" == typeof d) { d(b);
                                            break } } "function" == typeof e && e(b) }, this.logger);
                    g(function() { c ? f() : a.addEventListener ? a.addEventListener("load", f, !1) : a.attachEvent("onload", f) }, this.logger)() }, c.prototype.wrap = function(b, c) {
                    try {
                        var d;
                        if (d = "function" == typeof c ? c : function() {
                                return c || {} }, "function" != typeof b) return b;
                        if (b._isWrap) return b;
                        if (!b._wrapped) { b._wrapped = function() {
                                try {
                                    return b.apply(this, arguments) } catch (c) {
                                    throw c._rollbarContext = d(), c._rollbarContext._wrappedSource = b.toString(), a._rollbarWrappedError = c, c } }, b._wrapped._isWrap = !0;
                            for (var e in b) b.hasOwnProperty(e) && (b._wrapped[e] = b[e]) }
                        return b._wrapped } catch (f) {
                        return b } };
                ...
                var l = c.init(a, _rollbarConfig); })(window, document);
            /* eslint-enable */
            this.load(this.ready);
        };
    ...
    151: [function(require, module, exports) {
        ...
        SnapEngage.prototype.attachListeners = function() {
            ...
            window.SnapEngage.setCallback('StartChat', function() {
                self.analytics.track('Live Chat Conversation Started', {}, { context: { integration: integrationContext } });
            });
            ...
            window.SnapEngage.setCallback('ChatMessageReceived', function(agent) {
                self.analytics.track('Live Chat Message Received', { agentUsername: agent }, { context: { integration: integrationContext } });
            });

            // Callback is passed `message`
            // TODO: Eventually this might pass information about the message to Segment
            window.SnapEngage.setCallback('ChatMessageSent', function() {
                self.analytics.track('Live Chat Message Sent', {}, { context: { integration: integrationContext } });
            });
            ...
            window.SnapEngage.setCallback('Close', function() {
                self.analytics.track('Live Chat Conversation Ended', {}, { context: { integration: integrationContext } });
            });
        };
    ...
    156: [function(require, module, exports) {
        ...
        Trakio.prototype.initialize = function() {
            ...
            window.trak.io.load = window.trak.io.load || function(e) {
                var r = function(e) {
                        return function() { window.trak.push([e].concat(Array.prototype.slice.call(arguments, 0))); }; },
        ...
        Userlike.prototype.attachListeners = function() {
            ...
            window.userlikeTrackingEvent = function(eventName, globalCtx, sessionCtx) {
                if (eventName === 'chat_started') {
                    self.analytics.track(
                        'Live Chat Conversation Started', { agentId: sessionCtx.operator_id, agentName: sessionCtx.operator_name }, {
                            context: { integration: integrationContext }
                        });
                }
                if (eventName === 'message_operator_terminating') {
                    self.analytics.track(
                        'Live Chat Message Sent', { agentId: sessionCtx.operator_id, agentName: sessionCtx.operator_name }, {
                            context: { integration: integrationContext }
                        });
                }
                if (eventName === 'message_client_terminating') {
                    self.analytics.track(
                        'Live Chat Message Received', { agentId: sessionCtx.operator_id, agentName: sessionCtx.operator_name }, {
                            context: { integration: integrationContext }
                        });
                }
                if (eventName === 'chat_quit') {
                    self.analytics.track(
                        'Live Chat Conversation Ended', { agentId: sessionCtx.operator_id, agentName: sessionCtx.operator_name }, {
                            context: { integration: integrationContext }
                        });
                }
            };
                ...
                var i, s, z, w = window,
                    ...
                    c = function() {
                        ...
                        for (i = 0; i < f.length; i++) {
                            (function(f) { self[f] = function() { self._e.push([f].concat(Array.prototype.slice.call(arguments, 0)));
                                    return self; }; })(f[i]); } };
                w._w = w._w || {};
                for (i = 0; i < a.length; i++) { w._w[a[i]] = w[a[i]] = w[a[i]] || new c(); } })('woopra');
            /* eslint-enable */
